    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'abstract': False,
                'indexes': [models.Index(fields=['hub_id', 'status', '-created_at'], name='online_paym_hub_id_058cf8_idx'), models.Index(fields=['hub_id', 'source_type', 'source_id'], name='online_paym_hub_id_8af41e_idx')],
            },
        ),
    ]
